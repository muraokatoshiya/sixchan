...
class Res(db.Model):
    ...
    created_st = db.Column(db.DateTime, nullable=False, default=datetime.utcnow)
...
def insert_mock_reses():
    ...
    for res in mock_data["reses"]:
        created_st = datetime.fromisoformat(res.pop("created_st"))
        db.session.add(Res(created_st=created_st, **res))
    db.session.commit()
...
def index():
    ...
    if form.validate_on_submit():
        ...
        res = Res(
            ...
            email = form.author.data or None,
